module.exports = function(app) {
	...
	// TO-FIX: If you request any sub-directory it will fail to get the index (i.e. 127.0.0.1:8080/recipes because it tries to go to 127.0.0.1:8080/recipes/public/index.html)
